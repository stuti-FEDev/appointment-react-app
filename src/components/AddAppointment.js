...
const AddAppointemnt = ({onSendAppointment, lastId}) => {
    const clearData = {
        petName : '',
        ownerName: '',
        aptDate: '',
        ...
        </button>
        {
            toggleForm && 
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                    <input type="text" onChange={(e) => {setFormData({ ...formData, ownerName:e.target.value})}} name="ownerName" id="ownerName" value={formData.ownerName}
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                    <input type="text" name="petName" id="petName" onChange={(e) => {setFormData({ ...formData, petName:e.target.value})}} value={formData.petName}
                    className="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md" />
                </div>
                </div>
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                    <input type="date" onChange={(e) => {setFormData({ ...formData, aptDate:e.target.value})}} value={formData.aptDate} name="aptDate" id="aptDate"
                    className="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md" />
                </div>
                </div>
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                    <input type="time" onChange={(e) => {setFormData({ ...formData, aptTime:e.target.value})}} value={formData.aptTime} name="aptTime" id="aptTime"
                    className="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md" />
                </div>
                </div>
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                    <textarea id="aptNotes" onChange={(e) => {setFormData({ ...formData, aptNotes:e.target.value})}} value={formData.aptNotes} name="aptNotes" rows="3"
